...
```bash
# 1. Generate a comprehensive PRP directly from description
/generate-prp "implementar autenticação JWT com refresh tokens"

# 2. Execute the PRP to implement your feature
/execute-prp PRPs/001-autenticacao-jwt/PRP.md

# Alternative: Use existing INITIAL.md (retrocompatibility)
/generate-prp PRPs/templates/INITIAL.md
```

### Defining Your Requirements (Optional)

With the consolidated `/generate-prp`, you can pass a description directly. If you prefer more structure, `PRPs/templates/INITIAL.md` can include:
...
| `/generate-prp "descrição"` | Create implementation blueprint (consolidated) |
